				...
				<td valign="top">	
					<form method="POST" enctype="multipart/form-data">
								...
								<? if($isEnableJob=="active"){?>
									...
									<tr>
										<td width="120px"><?= $mform->label('jobname','Job Name','caption')?></td>
										<td><?= $mform->inputBox($task,'text','jobname',stripslashes(html_entity_decode($jobname)),'input iputshort','jobname','50');?></td>
									</tr>  
