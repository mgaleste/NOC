			...
			<table width="100%" cellpadding="0" cellspacing="0" id="myTable" class="tablesorter">					
				<thead>		
						...
						<th colspan="6">
							<table cellpadding="0" cellspacing="0" border="0" width="100%">
								<tr valign="middle">						
									...
									<td class="verdana10"><a href="index.php?mod=<?=$mod?>&type=site" class="sub_link"><img src="<?=MODIMAGES;?>pages.png" border="0" alt="" width="18" height="18">Service Provider Sites</a></td>
                                                                        <td>&nbsp;</td>
                                                                        <td>&nbsp;</td>
                                                                        <td>&nbsp;</td>
					...
					<tr valign="middle">
						...
						<th width="20%" class="table_line1_left">Service Provider Name</th>
						<th width="20%" class="table_line1_left">Address</th>
						<th width="15%" class="table_line1_left">Contact Number</th>
						<th width="15%" class="table_line1_left">eMail</th>
                                                <th width="20%" class="table_line1_left_right">Web Site</th>
					</tr>
			...
			<?php
				...
				if($num_rows>0){
					...
					for($i=0;$i<$num_rows;$i++){
						...
						$ids 				= mysql_result($result, $i, "serviceproviderId");
						$serviceproviderName		 	= mysql_result($result, $i, "serviceproviderName");
						...
						$link				= "index.php?mod=$mod&type=$type&task=view&sid=$ids";
							...
							echo '	<td align="center" class="table_line2_"><input class="ibox" value="'.$ids.'" name="delAnn[]" onclick="checkAllFields(2);" type="checkbox"></td>
									...
									<td class="table_line2_left">'.stripslashes(html_entity_decode($email)).'&nbsp;</td>
                                                                        <td class="table_line2_left_right">'.stripslashes(html_entity_decode($webSite)).'&nbsp;</td>';
